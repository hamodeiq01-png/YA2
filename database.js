...
function getAssignmentForStudentToday(studentId) {
  ...
  // Find assignment for today (local server date format YYYY-MM-DD)
  const todayStr = new Date().toLocaleDateString('sv'); // sv locale yields YYYY-MM-DD
...
function getAssignmentsHistoryForStudent(studentId) {
  ...
  // Get all assignments for this student's teacher, sorted descending
  return db.assignments
