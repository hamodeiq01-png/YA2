...
const dailyQuotes = [
  ...
  'قال ابن الجوزي: «ما رأيت أحدًا بلغ الغاية في العلم إلا وهو كثير القراءة والمطالعة» — فأكثر من القراءة تبلغ القمم.',
  ...
  'قال ابن القيم: «العلم يرفع العبد بلا عشيرة، والجهل يضع الشريف بلا قبيلة» — ارفع همتك بالقراءة والعلم!'
];
